...
create or replace procedure restore_companies(date_time date) is
    cursor records is
        select *
        from companies_logs
...
create or replace procedure restore_persons(date_time date) is
    cursor records is
        select *
        from persons_logs
        where action_date = date_time
...
create or replace procedure restore_cars(date_time date) is
    cursor records is
        select *
        from cars_logs
        where action_date = date_time
